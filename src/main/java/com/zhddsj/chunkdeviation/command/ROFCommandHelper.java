...
public class ROFCommandHelper<S extends CommandSource>
{
    ...
    public ROFCommandHelper(CommandNode<S> rootNode,CommandRegistryAccess commandRegistryAccess)
    {
    ...
    public ROFCommandHelper<S> getChild(String string){
        return new ROFCommandHelper<>(rootNode.getChild(string),commandRegistryAccess);
    }
